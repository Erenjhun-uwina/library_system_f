@extends('layout.main')
  ...
  <button id="about" class="tablink" onclick="openPage('About', this, 'pink')">About</button>
  ...
  <div id="Home" class="tabcontent">
    ...
    @forelse($transactions as $transaction)
      ...
      @php
        ...
        $borrower = Users::find($transaction->borrower);
        $book = Books::find($transaction->book)

      @endphp
    
      <div class="user_list"> {{$borrower->fn}} {{$borrower->ln}} ---- book:{{$book->title}} </div>
    @empty
